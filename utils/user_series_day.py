...
reg_script_name="yc_dm.py dm_user_reg_series_detail_info"
act_script_name="yc_dm.py dm_user_act_series_detail_info"
charge_script_name="yc_dm.py dm_user_charge_series_detail_info"
bi_reg_script_name="yc_bi.py bi_dm_user_reg_series_day"
bi_act_script_name="yc_bi.py bi_dm_user_act_series_day"
bi_charge_script_name="yc_bi.py bi_dm_user_charge_series_day"
#script_list=[charge_script_name,bi_reg_script_name,bi_act_script_name,charge_script_name,bi_charge_script_name]
script_list=[reg_script_name,act_script_name,charge_script_name,bi_reg_script_name,bi_act_script_name,charge_script_name,bi_charge_script_name]
