...
reg_script_name="yc_dm.py dm_driver_reg_series_detail_month"
act_script_name="yc_dm.py dm_driver_act_series_detail_month"
bi_reg_script_name="yc_bi.py bi_dm_driver_reg_series_month"
bi_act_script_name="yc_bi.py bi_dm_driver_act_series_month"
