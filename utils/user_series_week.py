...
print dt_day
reg_script_name="yc_dm.py dm_user_reg_series_detail_week"
act_script_name="yc_dm.py dm_user_act_series_detail_week"
charge_script_name="yc_dm.py dm_user_charge_series_detail_week"
bi_reg_script_name="yc_bi.py bi_dm_user_reg_series_week"
bi_act_script_name="yc_bi.py bi_dm_user_act_series_week"
bi_charge_script_name="yc_bi.py bi_dm_user_charge_series_week"
#script_list=[bi_reg_script_name,bi_act_script_name,charge_script_name]
