...
class table:
    def execute(self, argv):
        table = "bi_dm_user_charge_series_day"
        dir = "/tmp/"+table
        hdfs_1 = "/user/hive/warehouse/yc_ods_mid_bi.db/bi_dm_user_charge_series_day/"
        ...
        while start_time < end_time :
            ...
            print hdfs
            dt = dtoop()
            sql = """insert overwrite table yc_ods_mid_bi.bi_dm_user_charge_series_day partition(dt={dt_day})
            select count(user_id_charge),
            count(user_id_act_1day),
            count(user_id_act_2day),
            count(user_id_act_3day),
            count(user_id_act_4day),
            count(user_id_act_5day),
            count(user_id_act_6day),
            count(user_id_act_7day),
            count(user_id_act_8day),
            count(user_id_act_14day),
            count(user_id_act_30day),
            ...
            dt
            from yc_dm_mp.dm_user_charge_series_detail_info_day
