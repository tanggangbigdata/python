...
class table:
    def execute(self, argv):
        table = "bi_dm_driver_act_series_week"
        dir = "/tmp/"+table
        hdfs_1 = "/user/hive/warehouse/yc_ods_mid_bi.db/bi_dm_driver_act_series_week/"
        ...
        while start_time < end_time :
            ...
            dt = dtoop()
            sql = """insert overwrite table yc_ods_mid_bi.bi_dm_driver_act_series_week partition(dt={dt_day})
            select count(driver_id_act_week),
            ...
            dt
            from yc_dm_mp.dm_driver_act_series_detail_info_week
