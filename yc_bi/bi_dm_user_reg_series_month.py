...
class table:
    def execute(self, argv):
        table = "bi_dm_user_reg_series_mon"
        dir = "/tmp/"+table
        hdfs_1 = "/user/hive/warehouse/yc_ods_mid_bi.db/bi_dm_user_reg_series_mon/"
        ...
        while start_time < end_time :
            ...
            print hdfs
            dt = dtoop()
            sql = """insert overwrite table yc_ods_mid_bi.bi_dm_user_reg_series_mon partition(dt={dt_day})
            select count(user_id_reg_mon),
            ...
            dt
            from yc_dm_mp.dm_user_reg_series_detail_info_mon
