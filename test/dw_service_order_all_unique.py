...
class table:
  def execute(self,argv):
    ...
    while start_time<end_time:
       ...
       sql1="""
       insert overwrite table yc_dm_mp.dm_service_order_all_unique partition(dt=20170101)
...
from yc_ods.ods_service_order where dt<=20170101 and status=7)t1
where t1.num=1
       """
#       ychive().query(sql1)
       sql2="""
...
full outer join
(select * from yc_ods.ods_service_order where dt={dt} and status=7) t2
